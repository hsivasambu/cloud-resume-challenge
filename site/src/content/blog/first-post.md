...
While studying Engineering at McMaster University, that usually meant breaking things, fixing them, rebuilding them, and _very_ slowly understanding how systems actually worked under the hood. It was messy, frustrating, and incredibly rewarding. Somewhere along the way, as my career shifted deeper into project management and leadership roles, that hands-on time slowly faded. I stayed close to technology, but not always _inside_ it.
